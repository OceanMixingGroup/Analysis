...
fig_dir='/Users/Andy/Cruises_Research/Analysis/Andy_Pickering/eq14_patch_gamma/figures'
fname=['eq14_minOT_' num2str(100*patch_size_min) '_usetemp_' num2str(usetemp) '_gammas_hist_cast_' num2str(cast_range(1)) '_' num2str(cast_range(2)) ]
