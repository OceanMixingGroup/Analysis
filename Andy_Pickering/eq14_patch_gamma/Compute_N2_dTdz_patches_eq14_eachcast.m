...
%save_dir_patch='/Users/Andy/Cruises_Research/Analysis/Andy_Pickering/eq14_patch_gamma/data/patches/'
...
for cnum=1:4000
    ...
    try
        ...
        load(fullfile(save_dir_patch,['eq14_raw_patches_minOT_' num2str(100*patch_size_min) '_usetemp_' num2str(usetemp) '_cnum_' num2str(cnum) '.mat']))
