...
for cnum = 500%get_cham_cnums_eq14
...
%     
%     figure(2);clf
%     [xout, bb, hchi]=BinAndBootSingleProfile(chipod.eps,chipod.P,10,100,1)
%     hold on
%     [xout, bb, hcham]=BinAndBootSingleProfile(cham.eps,cham.P,10,100,1)
%     legend([hchi hcham],'\chipod','cham','location','best')
%     ylabel('P')
%     xlabel('\epsilon')
    
    %    plot(log10(xout),chipod.P)
