...
\begin{figure}[htbp]
\includegraphics[scale=0.8]{eq14_profile_1751_eps_profiles_compare.png}
\caption{Example of averaging multiple profiles together. Left panels show a single profile from chamleeon and chi-pod method. Right panels show average of $+/-$ 5 (middle) and 25 (right) profiles, averaged in 10m depth bins. Data in mixed layer and shallower than 20m have been excluded.}
\label{prof_avg_ex}
\end{figure}
...
\begin{figure}[htbp]
\includegraphics[scale=0.8]{eq14_chiVscham_chiANDeps_diff_dz_screen_chi_1.png}
