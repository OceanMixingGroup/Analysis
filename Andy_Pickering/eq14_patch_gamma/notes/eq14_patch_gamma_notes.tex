...
\begin{figure}[htbp]
\includegraphics[scale=0.8]{eq14_minOT_40_usetemp_1_gam_vs_cnum_depths_60_200.png}
...
\begin{figure}[htbp]
\includegraphics[scale=0.8]{ChiPatchEpsCompare_N2dTdz_line_fit_minOT40_usetemp_1.png}
...
\begin{figure}[htbp]
\includegraphics[scale=0.8]{ChiPatchEpsHist_N2dTdz_line_fit_minOT40_usetemp_1.png}
...
\begin{figure}[htbp]
\includegraphics[scale=0.8]{eps_prof_example.png}
