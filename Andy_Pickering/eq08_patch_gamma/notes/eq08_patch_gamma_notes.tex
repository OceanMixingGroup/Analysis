...
\begin{figure}[htbp]
\includegraphics[scale=0.8]{eq08_minOT_40_usetemp_1_patch_locs.png}
...
\begin{figure}[htbp]
\includegraphics[scale=0.8]{eq08_binned_gamma.png}
...
\begin{figure}[htbp]
\includegraphics[scale=0.8]{eq08_minOT_40_usetemp_1_gammas_hist2X2_depth_60_200m.png}
...
%% gamma for all binned data
%\begin{figure}[htbp]
%\includegraphics[scale=0.8]{eq08_binned_gamma_7hz.png}
...
\begin{figure}[htbp]
\includegraphics[scale=0.6]{eq08_minOT_40_usetemp_1_gammas_vs_eps2X2_60_200m.png}
...
\begin{figure}[htbp]
\includegraphics[scale=0.6]{eq08_minOT_40_usetemp_1_gam_vs_cnum_depths_60_200.png}
...
\begin{figure}[htbp]
\includegraphics[scale=0.6]{eq08_minOT_40_usetemp_1_gammas_vs_depth2X2.png}
...
%
%\begin{figure}[htbp]
%\includegraphics[scale=0.8]{ChiPatchChiCompare_N2dTdz_line_minOT40_usetemp_1.png}
...
\clearpage
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\section{Application of $\chi$pod method to binned data}
...
mfiles:
\begin{itemize}
\item \verb+ComputeChi_Chameleon_Eq08.m+ : The $\chi$pod method is applied.
\item \verb+Plot_eps_profiles_eq08.m+
\item all the profiles are combined into one structure in \verb+XXX?.m+.
\end{itemize}
...
\caption{Histogram of the ratio of $\epsilon$ estimates from $\chi$pod method to the chameleon values, for chi-pod method applied to 1m binned profiles. Estimates for each profile were averaged in 10m depth bins.}
\label{epsrathist}
\end{figure}


\begin{figure}[htbp]
\includegraphics[scale=0.8]{eq08eps_prof_comparisons.png}
...
\begin{figure}[htbp]
\includegraphics[scale=0.8]{eq08eps_prof_diffN.png}
