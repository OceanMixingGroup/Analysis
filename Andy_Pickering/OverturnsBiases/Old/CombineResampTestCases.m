%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%
% CombineResampTestCases.m
%
% Combine all T-chain resampling test cases (entire ensemble) into one structure to
% make it easier to load and analyze.
%
% Resampled data is made in ResampMPnew12Nov.m
%
%  7 Jan 2015 - A. Pickering
% 28 Jan 2015 - Also get 'true' T-chain profiles corresponding to times of resampled profiles
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%%
...
for  whtest=1:4
    ...
    load(fullfile(DatDir,['Test' num2str(testnum)],fname))
    ...
    REsamp.minOT=minOT;
    REsamp.MakeInfo=['Made ' datestr(now) ' w/ CombineResampTestCases.m in ' version]
