function h=plot_patch_N2_2X2(project_name,patch_size_min,usetemp,...
...
hold on
histogram(real(log10(patches.n2_bin(id2))),'Normalization','pdf', 'EdgeColor','none');
xlim([-6.5 -2])
freqline(-4);
grid on
xlabel('log_{10}[N^2 bin]','fontsize',16)
ylabel('pdf','fontsize',16)
      
ax2 = subplot(222) ;
h2=histogram(real(log10(patches.n2_line(id))),h1.BinEdges,'Normalization','pdf', 'EdgeColor','none');
hold on
histogram(real(log10(patches.n2_line(id2))),h1.BinEdges,'Normalization','pdf', 'EdgeColor','none');
xlim([-6.5 -2])
freqline(-4);
grid on
xlabel('log_{10}[N^2 line]','fontsize',16)
ylabel('pdf','fontsize',16)

ax3 = subplot(223) ;
h3=histogram(real(log10(patches.n2_bulk(id))),h1.BinEdges,'Normalization','pdf', 'EdgeColor','none');
hold on
histogram(real(log10(patches.n2_bulk(id2))),h1.BinEdges,'Normalization','pdf', 'EdgeColor','none');
xlim([-6.5 -2])
freqline(-4);
grid on
xlabel('log_{10}[N^2 bulk]','fontsize',16)
ylabel('pdf','fontsize',16)

ax4 = subplot(224) ;
h4=histogram(real(log10(patches.n2_line_fit(id))),h1.BinEdges,'Normalization','pdf', 'EdgeColor','none');
hold on
histogram(real(log10(patches.n2_line_fit(id2))),h1.BinEdges,'Normalization','pdf', 'EdgeColor','none');
xlim([-6.5 -2])
freqline(-4);
grid on
xlabel('log_{10}[N^2 line-fit]','fontsize',16)
ylabel('pdf','fontsize',16)
