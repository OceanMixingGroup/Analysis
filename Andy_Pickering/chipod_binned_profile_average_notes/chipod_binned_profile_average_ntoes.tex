...
%\begin{figure}[htbp]
%\includegraphics[scale=0.8]{eq08_10mbinned_eps_vs_chi_normalized_diffNprofileAvg.png}
%\caption{EQ08: 10m binned  chameleon $\epsilon/N\^2$ vs $\chi/t_{z}^{2}$, averaged over varying number of profiles. Lines show different values of $\gamma$. Data shallower than 80db have been discarded to avoid mixed layer where night-time convection occurs.}
%\label{}
%\end{figure}
