function h = PlotChiProfileCompare_eq14(cnum,Params,dz)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
ax1 = subplot(121);
hcham = plot(log10(avg.CHI),avg.P,'k','linewidth',2);
hold on
hchi = plot(log10(chb.chi1),chb.P,'.','markersize',15,'color',0.5*[1 1 1]);
axis ij
grid on
xlim([-11 -4])
ylim([0 200])
