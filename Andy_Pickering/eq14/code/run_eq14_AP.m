...
path_save = [path_cham 'processed_AP_7hz/mat' filesep];
mkdir(path_save)
%path_sum = [path_cham 'processed/sum' filesep];
path_sum = [path_cham 'processed_AP_7hz/sum' filesep];
mkdir(path_sum);
warning on
...
%    for cast = [2139:2550 2552:2996 2998:3092]
...
%        avg=average_data_gen1(q.series,'binsize',1,'nfft',nfft,'whole_bins',1);
        avg=average_data_gen1_AP_7hz(q.series,'binsize',1,'nfft',nfft,'whole_bins',1);
    ...
    %     end
        ...
        save( fullfile(path_save ,[fn '_avg.mat']),'avg','head')
